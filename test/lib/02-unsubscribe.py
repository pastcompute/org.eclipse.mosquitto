...
rc = 1
keepalive = 60
connect_packet = ecld_test.gen_connect("unsubscribe-test", keepalive=keepalive)
connack_packet = ecld_test.gen_connack(rc=0)

disconnect_packet = ecld_test.gen_disconnect()

mid = 1
unsubscribe_packet = ecld_test.gen_unsubscribe(mid, "unsubscribe/test")
...
try:
    ...
    if ecld_test.expect_packet(conn, "connect", connect_packet):
        ...
        if ecld_test.expect_packet(conn, "unsubscribe", unsubscribe_packet):
