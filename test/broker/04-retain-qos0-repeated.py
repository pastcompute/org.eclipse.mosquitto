...
keepalive = 60
mid = 16
connect_packet = ecld_test.gen_connect("retain-qos0-rep-test", keepalive=keepalive)
...
unsub_mid = 13
unsubscribe_packet = ecld_test.gen_unsubscribe(unsub_mid, "retain/qos0/test")
unsuback_packet = ecld_test.gen_unsuback(unsub_mid)
