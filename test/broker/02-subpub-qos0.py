...
mid = 53
keepalive = 60
connect_packet = ecld_test.gen_connect("subpub-qos0-test", keepalive=keepalive)
connack_packet = ecld_test.gen_connack(rc=0)

subscribe_packet = ecld_test.gen_subscribe(mid, "subpub/qos0", 0)
suback_packet = ecld_test.gen_suback(mid, 0)

publish_packet = ecld_test.gen_publish("subpub/qos0", qos=0, payload="message")
