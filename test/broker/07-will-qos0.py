...
mid = 53
keepalive = 60
connect_packet = ecld_test.gen_connect("will-qos0-test", keepalive=keepalive)
connack_packet = ecld_test.gen_connack(rc=0)

subscribe_packet = ecld_test.gen_subscribe(mid, "will/qos0/test", 0)
suback_packet = ecld_test.gen_suback(mid, 0)

publish_packet = ecld_test.gen_publish("will/qos0/test", qos=0, payload="will-message")
