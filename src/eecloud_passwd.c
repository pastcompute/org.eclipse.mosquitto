...
{
	printf("eecloud_passwd is a tool for managing password files for eecloud.\n\n");
	printf("Usage: eecloud_passwd [-c | -D] passwordfile username\n");
	printf("       eecloud_passwd -b passwordfile username password\n");
	printf("       eecloud_passwd -U passwordfile\n");
