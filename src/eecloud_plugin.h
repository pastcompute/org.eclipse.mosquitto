 ...
 *
 * gcc -I<path to eecloud_plugin.h> -fPIC -shared plugin.c -o plugin.so
 */
 ...
 *
 * There are also very useful functions in libeecloud.
 *
 * ========================================================================= */

/*
 * Function: eecloud_log_printf
 *
...
/*
 * Function: eecloud_auth_plugin_version
 *
...
/*
 * Function: eecloud_auth_plugin_init
 *
 * Called after the plugin has been loaded and <eecloud_auth_plugin_version>
 ...
 *	auth_opts :      Pointer to an array of struct eecloud_auth_opt, which
...
/*
 * Function: eecloud_auth_plugin_cleanup
 *
 * Called when the broker is shutting down. This will only ever be called once.
 * Note that <eecloud_auth_security_cleanup> will be called directly before
 * this function.
 *
 * Parameters:
 *
 *	user_data :      The pointer provided in <eecloud_auth_plugin_init>.
 *	auth_opts :      Pointer to an array of struct eecloud_auth_opt, which
 *	                 provides the plugin options defined in the configuration file.
 *	auth_opt_count : The number of elements in the auth_opts array.
 *
...
/*
 * Function: eecloud_auth_security_init
 *
 ...
 * <eecloud_auth_security_cleanup> will be called, followed by this function.
...
/* 
 * Function: eecloud_auth_security_cleanup
 *
 * Called when the broker cleans up the security functions when it shuts down.
 * If the broker is requested to reload its configuration whilst running,
 * this function will be called, followed by <eecloud_auth_security_init>.
 * In this situation, the reload parameter will be true.
 *
 * Parameters:
 *
