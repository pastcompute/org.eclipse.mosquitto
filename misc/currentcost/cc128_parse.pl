...
my $subclient = "/usr/bin/eecloud_sub -t sensors/cc128/raw -q 2";
my $pubclient = "/usr/bin/eecloud_pub -t sensors/cc128 -q 2 -l";
my $pubclient_ch1 = "/usr/bin/eecloud_pub -t sensors/cc128/ch1 -q 2 -l";
